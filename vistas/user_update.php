...
?>
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
            ...
            value="<?php echo $datos['usuario_usuario'] ?>" pattern="[a-zA-Z0-9]{4,20}" maxlength="20" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
            ...
            value="<?php echo $datos['usuario_email'] ?>" maxlength="70" >
				</div>
		  	</div>
		</div>
		<br><br>
		...
		<br><br><br>
		<p class="has-text-centered padding-8">
