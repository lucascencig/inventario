  ...
  if($total >= 1 && $pagina <= $Npaginas){
    ...
    foreach($datos as $rows){
      ...
      <tr class="has-text-centered" >
                ...
                <td>
                    <a href="index.php?vista=user_update&user_id_update='.$rows['usuario_id'].'" class="button is-success is-rounded is-small">Actualizar</a>
                </td>
                <td>
                    <a href="'.$url.$pagina.'&user_id_delete='.$rows['usuario_id'].'" class="button is-danger is-rounded is-small">Eliminar</a>
                </td>
            </tr>
            ';
      $contador++;
